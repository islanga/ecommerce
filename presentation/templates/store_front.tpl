	...
	<body>
		<div id="doc" class="yui-t2">
			<div id="bd">
				<div id="yui-main">
					<div class="yui-b">
						<div id="header" class="yui-g">
							<a href="{$obj->mSiteUrl}">
								<img src="{$obj->mSiteUrl}images/tshirtshop.jpg" height="100px" alt="tshirtshop logo" />
							</a>
						</div>
				...
				<div class="yui-b">
					{include file="../../presentation/templates/search_box.tpl"}
					{include file="../../presentation/templates/departments_list.tpl"}
