...
class StoreFront
{
	...
	// public $mContentsCell = '../../presentation/templates/blank.tpl';
	public $mContentsCell = '../../presentation/templates/first_page_contents.tpl';

	// Define the template file for the categories cell
	public $mCategoriesCell = '../../presentation/templates/blank.tpl';
	...
	public function init()
	{
		...
		{
			$this->mContentsCell = '../../presentation/templates/department.tpl';
			$this->mCategoriesCell = '../../presentation/templates/categories_list.tpl';
		}
